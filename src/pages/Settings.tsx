...
export default function Settings() {
  ...
  return (
    <div className="max-w-xl space-y-4">
      <header>
        <h1 className="cb-display text-3xl font-semibold">Settings</h1>
        <p className="mt-1 text-sm text-[var(--cb-muted)]">Account security and preferences.</p>
      </header>

      <section className="cb-panel p-4">
        <h2 className="cb-kicker">
          Change Password
        </h2>
