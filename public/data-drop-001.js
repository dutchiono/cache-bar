/* =====================================================================
   .cache — Drop 001 OG catalog (apparel + digital)
   Used only by drop-001-live.html, drop-001.html, and OG satellite pages.
   ===================================================================== */
...
/* Shared color palette ΓÇö swatch hex values keyed by friendly name */
window.PALETTE = {
  Bone:     '#dcd5c1',
  Black:    '#1a1a17',
  Ash:      '#7b7770',
...
window.PRODUCTS = [
  ...
  { name:'Hash Crewneck',   sku:'CSH-003', cat:'apparel', tag:'03', price:'INCLUDED',stock:'ok',  shape:'hoodie',  gar:'#b8b3a5', badge:'GIFT',         composition: 'Merino ├ù cotton blend',         madeIn: 'Yamanashi, JP',    run: 'Member', ships: 'With order',   colors:['Oat','Navy'] },
  ...
  { name:'Idle Shorts',     sku:'CSH-007', cat:'apparel', tag:'07', price:'$96',     stock:'out', shape:'shorts',  gar:'#a8a395', badge:'SOLD',         composition: '12oz canvas',                   madeIn: 'Lisbon, PT',       run: '500',  ships: 'ΓÇö',             colors:['Black','Sand'] },
  ...
  /* ---- book ΓÇö has both digital & physical formats ---- */
  {
