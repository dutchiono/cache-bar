...
window.FEATURED = [
  { sku:'STICKER-PACK-001', cat:'Sticker pack', name:'Cozy Devs 3-Pack', price:'TBD', drop:'01/09', shape:'sticker', glow:'#c8ff2d30', gar:'#e8e3d6', hot:true, tag:'PROOF NEXT',
    composition: 'Prodigi M-STI-5_5X5_5 ×3 · Moon Seal · Floppy · Bus Riot', madeIn: 'Prodigi UK', run: '50 packs' },
  { sku:'ECO-TEE-005', cat:'Apparel', name:'ElizaOS Rated E', price:'TBD', drop:'02/09', shape:'tee', glow:'#ffffff18', gar:'#1a1a17', hot:true, tag:'ART IN',
  ...
  { sku:'ECO-TEE-001', cat:'Apparel', name:'Deez Cache Tee', price:'TBD', drop:'03/09', shape:'tee', glow:'#72a7ff30', gar:'#2a2e3c', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/White · chest DTG', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-002', cat:'Apparel', name:'Foundry Desk Tee', price:'TBD', drop:'04/09', shape:'tee', glow:'#25d8c230', gar:'#1a1a17', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-003', cat:'Apparel', name:'Radar Ping Tee', price:'TBD', drop:'05/09', shape:'tee', glow:'#ff3b1f30', gar:'#2a2a25', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Navy/Black', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-001', cat:'Desk', name:'Bushleague Coffee Mug', price:'TBD', drop:'06/09', shape:'mug', glow:'#c4a47930', gar:'#dcd5c1', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · 11oz white ceramic', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-002', cat:'Desk', name:'.cache Field Mug', price:'TBD', drop:'07/09', shape:'mug', glow:'#c8ff2d30', gar:'#e8e3d6', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · terminal wrap', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-PAD-001', cat:'Desk', name:'Grid Cache Mouse Pad', price:'TBD', drop:'08/09', shape:'pad', glow:'#72a7ff30', gar:'#7b7770', hot:false, tag:'SAMPLE',
    composition: 'Prodigi GLOBAL-MOUSEMAT · 9.5×8″', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-TEE-004', cat:'Apparel', name:'Cheetofax Case Tee', price:'TBD', drop:'09/09', shape:'tee', glow:'#f6bd5c30', gar:'#4a4a32', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
];
...
window.PRODUCTS = [
  ...
  {
    name:'Deez Cache Tee', sku:'ECO-TEE-001', cat:'apparel', categoryLabel:'Tee', tag:'03', price:'TBD', stock:'ok', shape:'tee', gar:'#2a2e3c', badge:'SAMPLE',
  ...
  {
    name:'Foundry Desk Tee', sku:'ECO-TEE-002', cat:'apparel', categoryLabel:'Tee', tag:'04', price:'TBD', stock:'ok', shape:'tee', gar:'#1a1a17', badge:'SAMPLE',
  ...
  {
    name:'Radar Ping Tee', sku:'ECO-TEE-003', cat:'apparel', categoryLabel:'Tee', tag:'05', price:'TBD', stock:'ok', shape:'tee', gar:'#2a2a25', badge:'SAMPLE',
    composition:'Teemill RNA1', madeIn:'Teemill', run:'OE', ships:'After sample',
  ...
  {
    name:'Cheetofax Case Tee', sku:'ECO-TEE-004', cat:'apparel', categoryLabel:'Tee', tag:'06', price:'TBD', stock:'ok', shape:'tee', gar:'#4a4a32', badge:'SAMPLE',
    composition:'Teemill RNA1', madeIn:'Teemill', run:'OE', ships:'After sample',
  ...
  {
    name:'Bushleague Coffee Mug', sku:'ECO-MUG-001', cat:'desk', categoryLabel:'Mug', tag:'07', price:'TBD', stock:'ok', shape:'mug', gar:'#dcd5c1', badge:'SAMPLE',
  ...
  {
    name:'.cache Field Mug', sku:'ECO-MUG-002', cat:'desk', categoryLabel:'Mug', tag:'08', price:'TBD', stock:'ok', shape:'mug', gar:'#e8e3d6', badge:'SAMPLE',
  ...
  {
    name:'Grid Cache Mouse Pad', sku:'ECO-PAD-001', cat:'desk', categoryLabel:'Mouse pad', tag:'09', price:'TBD', stock:'ok', shape:'pad', gar:'#7b7770', badge:'SAMPLE',
...
window.ARCHIVE = [
  {
    ...
    pieces: 9,
    sold: 0,
    notes: 'ElizaOS Rated E art in. Teemill RNA1/RNK25 + Prodigi. Upscale draft → sample → price.',
