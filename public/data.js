...
window.FEATURED = [
  { sku:'STICKER-PACK-001', cat:'Sticker pack', name:'Cozy Devs 3-Pack', price:'TBD', drop:'01/10', shape:'sticker', glow:'#c8ff2d30', gar:'#e8e3d6', hot:true, tag:'PROOF NEXT',
    composition: 'Prodigi M-STI-5_5X5_5 ×3 · Moon Seal · Floppy · Bus Riot', madeIn: 'Prodigi UK', run: '50 packs' },
  { sku:'ECO-TEE-005', cat:'Apparel', name:'ElizaOS Rated E', price:'TBD', drop:'02/10', shape:'tee', glow:'#ffffff18', gar:'#1a1a17', hot:true, tag:'ART IN',
  ...
  { sku:'ECO-STI-001', cat:'Sticker', name:'4GT Profile', price:'TBD', drop:'03/10', shape:'sticker', glow:'#f6d54a30', gar:'#1a1a17', hot:true, tag:'ART IN',
    image:'/uploads/merch/4gt-profile.png',
    composition: 'Prodigi M-STI-5_5X5_5 matte kiss-cut', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-TEE-001', cat:'Apparel', name:'Deez Cache Tee', price:'TBD', drop:'04/10', shape:'tee', glow:'#72a7ff30', gar:'#2a2e3c', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/White · chest DTG', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-002', cat:'Apparel', name:'Foundry Desk Tee', price:'TBD', drop:'05/10', shape:'tee', glow:'#25d8c230', gar:'#1a1a17', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-003', cat:'Apparel', name:'Radar Ping Tee', price:'TBD', drop:'06/10', shape:'tee', glow:'#ff3b1f30', gar:'#2a2a25', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Navy/Black', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-001', cat:'Desk', name:'Bushleague Coffee Mug', price:'TBD', drop:'07/10', shape:'mug', glow:'#c4a47930', gar:'#dcd5c1', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · 11oz white ceramic', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-002', cat:'Desk', name:'.cache Field Mug', price:'TBD', drop:'08/10', shape:'mug', glow:'#c8ff2d30', gar:'#e8e3d6', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · terminal wrap', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MAT-001', cat:'Desk', name:'Ruby Labs Desk Mat', price:'TBD', drop:'09/10', shape:'mat', glow:'#9b7bff30', gar:'#e8e3d6', hot:true, tag:'ART IN',
    image:'/uploads/merch/ruby-labs-desk-mat.png',
    composition: 'Prodigi GLOBAL-GAMINGMAT · 31×15″', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-TEE-004', cat:'Apparel', name:'Cheetofax Case Tee', price:'TBD', drop:'10/10', shape:'tee', glow:'#f6bd5c30', gar:'#4a4a32', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
];
...
window.PRODUCTS = [
  ...
  },
  {
    ...
    designBrief:'Ruby Labs · NON SCHOLAE SED VITAE DISCIMUS · powered by Eliza OS', retailTarget:'$35–45',
  },
];
...
window.ARCHIVE = [
  {
    ...
    pieces: 10,
    sold: 0,
    notes: 'ElizaOS tee, 4GT sticker, Ruby Labs desk mat art in.',
