/* =====================================================================
   ...
   Teemill RNA1/RNK25 · Prodigi M-STI-5_5X5_5 / GLOBAL-GAMINGMAT
   ===================================================================== */
...
window.SOURCING = {
  ...
  deskMat: { supplier: 'Prodigi', sku: 'GLOBAL-GAMINGMAT', size: '31×15″ neoprene (UK large)' },
};
...
window.FEATURED = [
  { sku:'STICKER-PACK-001', cat:'Sticker pack', name:'Cozy Devs 3-Pack', price:'TBD', drop:'01/11', shape:'sticker', glow:'#c8ff2d30', gar:'#e8e3d6', hot:true, tag:'PROOF NEXT',
    composition: 'Prodigi M-STI-5_5X5_5 ×3 · Moon Seal · Floppy · Bus Riot', madeIn: 'Prodigi UK', run: '50 packs' },
  { sku:'ECO-TEE-005', cat:'Apparel', name:'ElizaOS Rated E', price:'TBD', drop:'02/11', shape:'tee', glow:'#ffffff18', gar:'#1a1a17', hot:true, tag:'ART IN',
    image:'/uploads/merch/elizaos-rated-e.png',
    composition: 'Teemill RNA1 · ESRB parody · Black/White', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-STI-001', cat:'Sticker', name:'4GT Profile', price:'TBD', drop:'03/11', shape:'sticker', glow:'#f6d54a30', gar:'#1a1a17', hot:true, tag:'ART IN',
    image:'/uploads/merch/4gt-profile.png',
    composition: 'Prodigi M-STI-5_5X5_5 matte kiss-cut', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-TEE-001', cat:'Apparel', name:'Deez Cache Tee', price:'TBD', drop:'04/11', shape:'tee', glow:'#72a7ff30', gar:'#2a2e3c', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/White · chest DTG', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-002', cat:'Apparel', name:'Foundry Desk Tee', price:'TBD', drop:'05/11', shape:'tee', glow:'#25d8c230', gar:'#1a1a17', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-TEE-003', cat:'Apparel', name:'Radar Ping Tee', price:'TBD', drop:'06/11', shape:'tee', glow:'#ff3b1f30', gar:'#2a2a25', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Navy/Black', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-001', cat:'Desk', name:'Bushleague Coffee Mug', price:'TBD', drop:'07/11', shape:'mug', glow:'#c4a47930', gar:'#dcd5c1', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · 11oz white ceramic', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MUG-002', cat:'Desk', name:'.cache Field Mug', price:'TBD', drop:'08/11', shape:'mug', glow:'#c8ff2d30', gar:'#e8e3d6', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNK25 · terminal wrap', madeIn: 'Teemill UK', run: 'Open edition' },
  { sku:'ECO-MAT-001', cat:'Desk', name:'Ruby Labs Desk Mat', price:'TBD', drop:'09/11', shape:'mat', glow:'#9b7bff30', gar:'#e8e3d6', hot:true, tag:'ART IN',
    image:'/uploads/merch/ruby-labs-desk-mat.png',
    composition: 'Prodigi GLOBAL-GAMINGMAT · 31×15″', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-STI-002', cat:'Sticker', name:'Ruby Labs Seal', price:'TBD', drop:'10/11', shape:'sticker', glow:'#6b8cff30', gar:'#e8e3d6', hot:true, tag:'ART IN',
    image:'/uploads/merch/ruby-labs-seal.png',
    composition: 'Prodigi M-STI-5_5X5_5 · round seal', madeIn: 'Prodigi', run: 'Open edition' },
  { sku:'ECO-TEE-004', cat:'Apparel', name:'Cheetofax Case Tee', price:'TBD', drop:'11/11', shape:'tee', glow:'#f6bd5c30', gar:'#4a4a32', hot:false, tag:'SAMPLE',
    composition: 'Teemill RNA1 · Black/Grey', madeIn: 'Teemill UK', run: 'Open edition' },
];
...
window.PRODUCTS = [
  ...
  {
    name:'ElizaOS Rated E', sku:'ECO-TEE-005', cat:'apparel', categoryLabel:'Tee', tag:'02', price:'TBD', stock:'ok', shape:'tee', gar:'#1a1a17', badge:'ART IN',
    image:'/uploads/merch/elizaos-rated-e.png',
    composition:'Teemill RNA1 · ESRB-style parody', madeIn:'Teemill', run:'OE', ships:'Upscale + sample',
    colors:['Black','White'], project:'elizaos',
    blank:"Teemill Men's Basic T-shirt", supplierSku:'RNA1', printFile:'Source 473×657 — upscale to 4500×5400 chest',
    designBrief:'ELIZAOS / E / ESRB parody — art in repo', retailTarget:'$28–32',
  },
  {
    name:'4GT Profile', sku:'ECO-STI-001', cat:'sticker', categoryLabel:'Sticker', tag:'03', price:'TBD', stock:'ok', shape:'sticker', gar:'#1a1a17', badge:'ART IN',
    image:'/uploads/merch/4gt-profile.png',
    composition:'Prodigi medium matte kiss-cut', madeIn:'Prodigi', run:'OE', ships:'Sample sticker',
    colors:['Matt vinyl'], project:'bushleague',
    blank:'M-STI-5_5X5_5 · 140×140mm', supplierSku:'M-STI-5_5X5_5', printFile:'PNG 799×799 — pad to 1650×1650',
    designBrief:'Profile silhouette · black/white/yellow', retailTarget:'$4–6',
  },
  {
    name:'Deez Cache Tee', sku:'ECO-TEE-001', cat:'apparel', categoryLabel:'Tee', tag:'04', price:'TBD', stock:'ok', shape:'tee', gar:'#2a2e3c', badge:'SAMPLE',
  ...
  {
    name:'Foundry Desk Tee', sku:'ECO-TEE-002', cat:'apparel', categoryLabel:'Tee', tag:'05', price:'TBD', stock:'ok', shape:'tee', gar:'#1a1a17', badge:'SAMPLE',
  ...
  {
    name:'Radar Ping Tee', sku:'ECO-TEE-003', cat:'apparel', categoryLabel:'Tee', tag:'06', price:'TBD', stock:'ok', shape:'tee', gar:'#2a2a25', badge:'SAMPLE',
    composition:'Teemill RNA1', madeIn:'Teemill', run:'OE', ships:'After sample',
  ...
  {
    name:'Cheetofax Case Tee', sku:'ECO-TEE-004', cat:'apparel', categoryLabel:'Tee', tag:'07', price:'TBD', stock:'ok', shape:'tee', gar:'#4a4a32', badge:'SAMPLE',
    composition:'Teemill RNA1', madeIn:'Teemill', run:'OE', ships:'After sample',
  ...
  {
    name:'Bushleague Coffee Mug', sku:'ECO-MUG-001', cat:'desk', categoryLabel:'Mug', tag:'08', price:'TBD', stock:'ok', shape:'mug', gar:'#dcd5c1', badge:'SAMPLE',
  ...
  {
    name:'.cache Field Mug', sku:'ECO-MUG-002', cat:'desk', categoryLabel:'Mug', tag:'09', price:'TBD', stock:'ok', shape:'mug', gar:'#e8e3d6', badge:'SAMPLE',
  ...
  {
    name:'Ruby Labs Desk Mat', sku:'ECO-MAT-001', cat:'desk', categoryLabel:'Desk mat', tag:'10', price:'TBD', stock:'ok', shape:'mat', gar:'#e8e3d6', badge:'ART IN',
    image:'/uploads/merch/ruby-labs-desk-mat.png',
    composition:'Prodigi large gaming mat · Eliza OS', madeIn:'Prodigi', run:'OE', ships:'Sample mat',
    colors:['Full bleed'], project:'ruby-labs',
    blank:'GLOBAL-GAMINGMAT · 31×15″ (78.7×38cm)', supplierSku:'GLOBAL-GAMINGMAT', printFile:'JPG ~9300×4500 @300dpi (source 1897×829)',
    designBrief:'Ruby Labs wide plaque · NON SCHOLAE SED VITAE DISCIMUS', retailTarget:'$35–45',
  },
  {
    name:'Ruby Labs Seal', sku:'ECO-STI-002', cat:'sticker', categoryLabel:'Sticker', tag:'11', price:'TBD', stock:'ok', shape:'sticker', gar:'#e8e3d6', badge:'ART IN',
    image:'/uploads/merch/ruby-labs-seal.png',
    composition:'Prodigi medium matte kiss-cut', madeIn:'Prodigi', run:'OE', ships:'Sample sticker',
    colors:['Matt vinyl'], project:'ruby-labs',
    blank:'M-STI-5_5X5_5 · 140×140mm', supplierSku:'M-STI-5_5X5_5', printFile:'PNG 1254×1254 — pad to 1650×1650',
    designBrief:'Ruby Labs round seal · flask/book · powered by Eliza OS', retailTarget:'$4–6',
  },
];
...
window.ARCHIVE = [
  {
    ...
    pieces: 11,
    sold: 0,
    notes: 'Ruby Labs desk mat + seal, ElizaOS tee, 4GT sticker art in.',
