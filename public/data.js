...
window.FEATURED = [
  ...
  { sku:'ECO-PAD-001', cat:'Desk', name:'Grid Cache Mouse Pad', price:'TBD', drop:'09/10', shape:'pad', glow:'#72a7ff30', gar:'#7b7770', hot:false, tag:'SAMPLE',
...
window.PRODUCTS = [
  ...
  {
    name:'Grid Cache Mouse Pad', sku:'ECO-PAD-001', cat:'desk', categoryLabel:'Mouse pad', tag:'10', price:'TBD', stock:'ok', shape:'pad', gar:'#7b7770', badge:'SAMPLE',
...
window.ARCHIVE = [
  {
    ...
    pieces: 10,
    sold: 0,
    notes: 'ElizaOS tee + 4GT sticker art in. Sample → proof → price.',
