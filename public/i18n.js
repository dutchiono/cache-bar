...
window.I18N = {
  ...
  en: {
    ...
    hero: {
      ...
      kicker: '// .cache shop',
      tag1: 'Live drop is three stickers — ',
      tagLimit: '50 each',
      tag2: '. Price after proof. Same flow for whatever we add next.',
      viewDrop: 'View shop',
      toInvalidation: 'to proof lock',
    },
    feat: {
      eyebrow: '// Live drop — 03 SKUs',
      titleA: 'Shop the', titleB: 'run.',
      aside: 'Three SKUs in the shop today. Add to cart, submit a request, we handle proof and fulfillment before charging.',
      prev: 'Prev', next: 'Next',
    },
    inv: {
    ...
    man: {
      ...
      foot1: 'Pilot batch', foot1Sub: '3 SKUs · 50 each',
      foot2: 'Price', foot2Sub: 'TBD until proof',
    },
    mem: {
      eyebrow: '// Ops · shop backend',
      headA: 'Shop', headB: 'live.', headC: 'Ops wired.',
      intro: 'Public shop is live on a three-SKU sticker batch. Catalog, fulfillment, and requests run through the same ops stack the rest of the merch will use.',
      path1Num: 'Agent',
