...
window.I18N = {
  ...
  /* =================== ENGLISH =================== */
  en: {
    nav: { drop: 'Sticker Run', inventory: 'Stickers', manifesto: 'Method', archive: 'Archive', ambassador: 'Reserve', members: 'POD', cart: 'Cart' },
    hero: {
    ...
    inv: {
      ...
      all: 'All', apparel: 'Stickers', knit: 'POD', headwear: 'Proofs', objects: 'Reserve', digital: 'Files',
