...
window.I18N = {
  ...
  en: {
    ...
    man: {
      ...
      foot1: 'Eco run', foot1Sub: '8 SKUs · sticker pack live',
      foot2: 'Price', foot2Sub: 'TBD until proof',
    },
    mem: {
      eyebrow: '// Ops · shop backend',
      headA: 'Shop', headB: 'live.', headC: 'Ops wired.',
      intro: 'Eco merch catalog is listed — shirts, mugs, mouse pad, sticker pack. Sticker checkout is wired; apparel/desk SKUs use request → proof → Teemill/POD before charge.',
      path1Num: 'Agent',
