...
large datasets as it has no memory pressure.`,
  ...
  prodigi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  prodigi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  prodigi-pp-cli export <resource> --format jsonl | jq '.id'`,
