...
but do not stop the import.`,
  ...
  prodigi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  prodigi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | prodigi-pp-cli import <resource> --input -`,
