...
export const ECO_MERCH_SOURCING: EcoMerchSku[] = [
  ...
  {
    cacheSku: "ECO-PAD-001",
    name: "Grid Cache Mouse Pad",
    supplier: "prodigi",
    prodigiSku: "GLOBAL-MOUSEMAT",
    blank: "9.5×8″ neoprene desk mat",
    colors: ["Full bleed"],
    printSpec: "JPG/PDF 2850×2400 @300dpi full bleed",
    designBrief: "Eco project grid — original glyphs only",
    retailTargetUsd: "18–22",
  },
  {
